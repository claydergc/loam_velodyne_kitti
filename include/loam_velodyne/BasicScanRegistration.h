...
namespace loam
{
  ...
  public:
    ...
    */
    void processScanlines(const float& scanTime, std::vector<pcl::PointCloud<pcl::PointXYZI>> const& laserCloudScans);
  ...
  private:
     ...
     */
    void reset(const float& scanTime);
  ...
  private:
    ...
    float _sweepStart;            ///< time stamp of beginning of current sweep
    float _scanTime;              ///< time stamp of most recent scan
